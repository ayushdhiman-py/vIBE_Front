  ...
  return (
    <>
      <div className="privacy-section">
        <div className="privacy-main-heading-text">
          <h1>Privacy Policy</h1>
          <p>
            Your Privacy is important to us at vIBE.We respect your privacy
            regarding any information wecollect from you from across our
            website.
          </p>
          <p>
            This privacy notice for vIBE Private Limited (doing business as
            vIBE) ('vIBE', 'we', 'us', or 'our',), describes how and why we
            might collect, store, use, and/or share ('process') your information
            when you use our services ('Services'). We know that You (a visitor
            or a registered user) care how information about You is used and
            shared, and we appreciate Your trust that we will do so carefully
            and sensibly. We let You retain as much control as possible over
            Your personal information. However, you may not visit and use our
            site at any time without telling us who You are or revealing the
            required information about Yourself. To the Company, our most
            important asset is our relationship with You. We are committed to
            maintaining the confidentiality, integrity and security of any
            personal information about our users of our site. We are proud of
            our privacy practices and the strength of our site security and want
            you to know how we protect Your information and use it to provide to
            You the services. This notice describes our privacy policy. By
            visiting this Website, You are accepting the practices described in
            this Privacy Policy. You further agree and consent to our
            collection, use, processing, disclosure and transfer of your
            personal data according to the provisions of this Privacy Policy{" "}
          </p>
        </div>
        <div className="privacy-heading-text">
          ...
          <p>
            ...
            information we collect may include but not restricted to names,
            phone numbers, email addresses, mailing addresses, billing
            addresses, contact or authentication data, usernames, debit/credit
            card numbers
          </p>
          ...
          <p>
            ...
            payment instrument. All payment data is stored by Razorpay. You may
          ...
          <p>
            ...
            camera, sensors, sms messages, storage, and other features. If you
            ...
            you may turn them off in your device's settings. <br />
          ...
          <p>
            Information automatically collected: We automatically collect
          ...
          <p>
            The information we collect includes Location Data. We collect
        ...
        <div className="privacy-heading-text">
          ...
          <p>
            ...
            account, as well as keep your account in working order, may process
            your information to provide you with the requested service, may
            process your information to respond to your inquiries and solve any
            potential issues you might have with the requested service, may
            process your information to fulfil and manage your orders, payments,
            returns, and exchanges made through the Services, may process your
            information when necessary to request feedback and to contact you
            about your use of our Services, may process the personal information
            ...
            emails at any time. We can also may process your information to
            develop and display personalised content and advertising tailored to
            your interests, location, and more, may process your information
            when we believe it is necessary to identify usage trends, determine
            the effectiveness of our promotional campaigns, and to evaluate and
            improve our Services, products, marketing, and your experience, may
        ...
        <div className="privacy-heading-text">
          <h1>Photos, Scans And Images</h1>
          <p>
            When you submit (or grant us permission to take) a photo,
            facial/body scan, or other image of you, we don’t share those
            photos, scans, or images, or any data captured in the body scans,
            with any third parties, but we may use them to measure your chest
            width and upper body length, to map and measure your body features,
            to address certain problems or concerns you may have with your t
            shirts, to help better understand how our clothing fit our customers
            and provide recommendations. Business Transfers: As we continue to
            develop our business, we might be acquired completely or merge with
            any other company. In such transactions, customer information
            generally is one of the transferred business assets. In such a case,
            we will ensure the protection of Your information as per these
            policies and guidelines. You hereby specifically consent and grant
            permission to the disclosure, and transferring, of information to
            such third parties.
          </p>

          <p>
            Protection of the Company and Others: We release account and other
            personal information when we believe release is appropriate to
            comply with law; to enforce or apply our Terms and Conditions and
            other agreements; or protect the rights, property, or safety of
            Company, our users, or others. This includes exchanging information
            with other companies and organizations for fraud protection and
            other similar matters. You hereby specifically consent and grant
            permission to disclosure and transferring of information to such
            third parties, as maybe required.
          </p>
        </div>
        <div className="privacy-heading-text">
          <h1>Cookie Policy</h1>
          <p>
            ...
            enable various features of Lenskart.com. "Cookies" are used to store
        ...
        <div className="privacy-heading-text">
          ...
          <p>
            ...
            information, we will either delete or anonymise such information,
            ...
            Keeping your data safe: We have implemented appropriate and
            reasonable technical and organisational security measures designed
        ...
        <div className="privacy-heading-text">
          <h1>Does We make Update To The Notice?</h1>
          <p>
        ...
        <div className="privacy-heading-text">
          <h1>How can you contact us about the Notice?</h1>
          <p>
            If you have questions or comments about this notice, you may contact
            our Data Protection Officer (DPO), Confidential, by email at
            Confidential, by phone at Confidential, or by post to:
          </p>

          <p>vIBE Private Limited Confidential __________ __________</p>
          <p>
            If you have any further questions or comments, you may also contact
            us by post at the following corporate address:
          </p>

          <p>
            vIBE Private Limited <br />
